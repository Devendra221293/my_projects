     	 ...
     	 //update customer data
            ...
            var user_name      = $('#id_user_name').val();
				...
				//prevent form if fields are empty
		  				if(name!="" && last_name!="" )
		  				{
			var detail='&username='+username+'&name='+name+'&last_name='+last_name+'&email='+email+'&contact_number='+contact_number+'&city='+city+;
...
<div class="title-block" id="registered_message" style="display:none;" >
         <h3 class="title" style="text-align:center;color:green">Customer has been registerd successfully</h3> 
</div>
...
<fieldset class="form-group col-md-6">
          <label for="inputphone" class="control-label">Contact Number</label></span>
...
<div class="form-group">
          <input id="save" type="button" value="Save" class="btn btn-primary" style="width:30%; margin-left:2%;"/>
           ...
           <input id="cancel" type="button" value="Reset" class="btn btn-primary" onClick="javascript:history.back();"  style="width:30%"/>		
</div>
